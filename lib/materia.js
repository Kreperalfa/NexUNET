...
export async function crearMateria(nombreMateria, unidadCredito, idCuentaActual) {
  ...
  /* ============================================================
     1. Buscar el departamento vinculado a la cuenta actual
     ============================================================ */
  ...
  /* ============================================================
     2. Insertar materia con idDepartamento automático
     ============================================================ */
  ...
  return { ok: true, mensaje: "Materia creada correctamente.", materia: data[0] };
}
